Blockly.Blocks['xbot_blynk_connect'] = {
  init: function() {
    ...
    Blockly.Msg.XBOT_BLYNK_CONNECT_MESSAGE0,
      ...
      "helpUrl": 
        Blockly.Msg.XBOT_BLYNK_CONNECT_HELPURL
    });
  }
};
    ...
    "args0": [
      {
        "type": "field_variable",
        "name": "value",
        "variable": Blockly.Msg.XBOT_BLYNK_APP_PIN_WRITE_MESSAGE1
      },
      {
        "type": "field_dropdown",
        "name": "pin",
...
Blockly.Python['xbot_blynk_app_pin_write'] = function(block) {
...
Blockly.Python['xbot_blynk_update_pin'] = function(block) {
...
Blockly.Python['xbot_blynk_notify'] = function(block) {
...
Blockly.Python['xbot_blynk_email'] = function(block) {
...
Blockly.Python['xbot_blynk_run'] = function(block) {
  // TODO: Assemble Python into code variable.
  var code = 'blynk.run()\n';
  return code;
};